...
function App() {
  ...
  return (
    <>
      <h1 className="title-bar">Sasidu</h1>
      ...
      <ProductCard name="Samsung Galaxy" price="$299.99" image="https://d2bschjhk4kxui.cloudfront.net/assets/images/product/69a6b033c3db51772531763.webp"/>
    </>
  )
}
